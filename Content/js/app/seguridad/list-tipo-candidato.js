            ...
            var table = $('#datatable').DataTable({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        attr: {
                            title: "Añadir nuevo tipo candidato",
                            onclick: "Modal()"
                        }
                    }
                ...
                columnDefs: [
...

                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            if (type == "display") {
                                botones += '<button class="btn btn-secondary btn-sm" onclick="EditarTipoCandidato(' + row.tipcan_Id + ')"><i class="mdi mdi-file-edit-outline"></i></button> | ';
                                botones += '<button class="btn btn-danger btn-sm" onclick="EliminarTipoCandidato(' + row.tipcan_Id + ')"><i class="mdi mdi-delete-empty-outline"></i></button>';
                            }
                            return botones;
                        }
                    }

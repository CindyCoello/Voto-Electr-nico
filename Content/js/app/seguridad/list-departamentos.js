                ...
                columnDefs: [
...

                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            if (type == "display") {
                                botones += '<button class="btn btn-secondary btn-sm" onclick="EditarDepartamento(' + row.depto_Id + ')"><i class="mdi mdi-file-edit-outline"></i></button> | ';
                                botones += '<button class="btn btn-danger btn-sm" onclick="EliminarDepartamento(' + row.depto_Id + ')"><i class="mdi mdi-delete-empty-outline"></i></button>';
                            }
                            return botones;
                        }
                    }
